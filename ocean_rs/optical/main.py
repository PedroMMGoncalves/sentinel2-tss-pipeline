"""
Main entry point for OceanRS Optical — Sentinel-2 Water Quality Pipeline.
...
Usage:
    ...
    CLI mode:
        python -m ocean_rs.optical -i <input_folder> -o <output_folder>
...
def cli_main():
    ...
    parser = argparse.ArgumentParser(
        description="OceanRS Optical — S2 Processing & TSS Estimation Pipeline",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python -m ocean_rs.optical -i D:/L1C_Products -o D:/Results
  python -m ocean_rs.optical -i /path/to/l1c -o /path/to/results --mode s2_processing_only
  python -m ocean_rs.optical -i ./c2rcc_products -o ./tss_results --mode tss_processing_only --enable-tss
        """
    )
